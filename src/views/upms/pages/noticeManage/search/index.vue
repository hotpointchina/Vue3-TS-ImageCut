  ...
  <div ref="searchGroup" class="search_group">
    <el-form
      ...
      <el-row class="search_form_row">
        <el-col :span="5">
          <el-form-item label="通知标题" prop="noticeTitle" class="search-form-item">
            <el-input v-model="queryForm.noticeTitle" placeholder="请输入通知标题" />
          </el-form-item>
        </el-col>
        <el-col :span="5">
          <el-form-item label="接收系统" prop="receiveSystem" class="search-form-item">
            <el-select v-model="queryForm.receiveSystem" placeholder="请选择接收系统">
              <el-option
...
const submitForm = async (formEl: FormInstance | undefined) => {
  ...
  await formEl.validate((valid, fields) => {
    if (valid) {
      ...
      //校验不通过处理，根据需求补充
      ElMessage.error('提交校验未通过，请核对查询数据！')
    }
  })
}
/**
