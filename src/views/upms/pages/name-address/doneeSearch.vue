  ...
  <div ref="searchGroup" class="search_group">
    ...
    >
      <el-row class="search_form_row">
        <el-col :span="5">
          <el-form-item label="公益组织" prop="doneeName" class="search-form-item">
            <el-input v-model="queryForm.doneeName" placeholder="请输入公益组织" />
          </el-form-item>
        </el-col>
        ...
        <el-col :span="5">
          <!-- <el-form-item label="类型" prop="type" class="search-form-item">
