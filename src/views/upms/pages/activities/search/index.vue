...
<!--            <el-date-picker v-model="queryForm.startTime" type="datetime" format="YYYY-MM-DD" value-format="YYYY-MM-DD"-->
<!--              placeholder="请选择" />-->
<!--          </el-form-item>-->
<!--        </el-col>-->
<!--        <el-col :span="5">-->
<!--          <el-form-item label="创建止期" prop="endTime" class="search-form-item">-->
<!--            <el-date-picker v-model="queryForm.endTime" type="datetime" format="YYYY-MM-DD" value-format="YYYY-MM-DD"-->
<!--              placeholder="请选择" />-->
<!--          </el-form-item>-->
<!--        </el-col>-->
        <el-col :span="10">
          <el-form-item label="申请时间" prop="createTime" class="search-form-item">
            <el-date-picker
...
<!--            <el-option v-for="item in flagStatusOptions" :label="item.name" :value="item.value" />-->
<!--          </el-select>-->
<!--        </el-form-item>-->
<!--      </el-col>-->
      <el-row class="search_form_row">
        <el-col :span="5">
          <el-form-item label="状态" class="search-form-item" prop="status">
    ...
    >
      <div class="base-table">
        ...
        >
          ...
          <el-table-column property="activitiesName" label="活动名称" width="100" />
...
import { queryList } from '/@/views/upms/api/pbdOrg';
...
const submitForm = () => {
  const endTime = parseDate(queryForm.activitiesStartTime[0]);
  const startTime = parseDate(queryForm.activitiesEndTime[1]);
...
const resetForm = () => {
  ...
  let startDate = dayjs(new Date()).subtract(30, 'day').format('YYYY-MM-DD');
  queryForm.activitiesEndTime = endDate;
  queryForm.activitiesStartTime = startDate;
  submitForm();
};
