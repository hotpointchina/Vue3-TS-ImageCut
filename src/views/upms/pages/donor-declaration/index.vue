...
<!--          <el-table-column property="age" :show-overflow-tooltip="true" label="年龄" />-->
          <el-table-column property="type" :show-overflow-tooltip="true" label="类型">
            <template #default="scope">
...
<!--              >-->
              <el-button
                ...
                v-if="scope.row.applyStatus == '5' && scope.row.type =='1' "
...
<!--              >-->
        ...
        >
          ...
          <el-descriptions class="margin-top" :column="1" size="default" :border="true">
            ...
            <el-descriptions-item label="活动图片" label-align="left" align="center">
          ...
          <div style="overflow: auto; height: 450px">
            <div v-for="(record, index) in approval" class="divHeight" :key="record.id">
              ...
              <div class="divContent">
                <p style="font-weight: bold">审核人&nbsp;: {{ record.approverName }}</p>
